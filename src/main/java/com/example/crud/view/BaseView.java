...
public class BaseView {
    ...
    public BaseView(WriterView writerViewMenu, PostView postViewMenu, LabelView labelViewMenu) {
        writerView = writerViewMenu;
        postView = postViewMenu;
        labelView = labelViewMenu;
    }
